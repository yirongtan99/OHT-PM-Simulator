...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        Text = "OHT Mark 2 PM Workflow Simulator V4";
    ...
    private void BuildRightPane(TableLayoutPanel root)
    {
        ...
        wfCard.Controls.Add(lblReading);
        ...
        wfCard.Controls.Add(waveformBox);
    ...
    private void UpdateWaveformImage()
    {
        ...
        if (selected is not null && selected.Handle != IntPtr.Zero)
        {
            ...
            if (captured is not null)
            {
                ...
                SetPicture(waveformBox, captured);
                return;
            }
        }
